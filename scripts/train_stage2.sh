#!/bin/bash
# Stage 2 Training Script - Defect Detection
...
MAX_PIXELS=3000000 \
swift sft \
    --model OUTPUT_DIR/stage1/checkpoint-LAST \
        --train_type lora \
    --dataset 'DATA_PATH/stage2_cn.json' \
              'DATA_PATH/stage2_en.json' \
              'DATA_PATH/stage2_general.json' \
    --num_train_epochs 1 \
